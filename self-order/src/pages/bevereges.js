...
import styles from "./bevereges.module.css";
const Bevereges = () => {
  ...
  return (
    <div className={styles.bevereges}>
      <img
      ...
      <div className={styles.beveregesChild} />
      <div className={styles.beveregesInner}>
      ...
      <div className={styles.beveregesItem} onClick={onRectangle3Click} />
